...
| `unchecked_shl` | `unchecked_shl.rs`; `unchecked_shl-fail.rs`; `show/unchecked_shl-fail.*.expected` | Partial | Part 1: `i8`, `i16`, `i32`, `i64`, `i128`, `u8`, `u16`, `u32`, `u64`, `u128` | Branch-local passes: `unchecked_shl_u8`, `unchecked_shl_u16`, `unchecked_shl_u32`, `unchecked_shl_u64`. Next technical step remains `unchecked_shl_u128`. |
