...
| `Rc<T:?Sized,A:Allocator>::from_raw_in` | `alloc::rc` | Verification-shaped proof harness added; frontier still recorded | Raw pointer must come from `Rc::into_raw`, allocator provenance must match, and ownership must be recovered exactly once. | Symbolic proof harness: `kmir/src/tests/integration/data/verify-rust-std/0026-rc/rc-from-raw-in.rs`. Minimal frontier reproducer: `kmir/src/tests/integration/data/verify-rust-std/0026-rc/rc-new-in-frontier-fail.rs`. Broader frontier reproducer: `kmir/src/tests/integration/data/verify-rust-std/0026-rc/rc-from-raw-in-frontier-fail.rs`. The frontier still ends at `CastKind::Transmute`. |
