...
fn main() {
    verify_to_int_unchecked_f16_i8(0.0);
    verify_to_int_unchecked_f32_i32(0.0);
    verify_to_int_unchecked_f64_i64(0.0);
    verify_to_int_unchecked_f128_i128(0.0);
}

fn verify_to_int_unchecked_f16_i8(a: f16) {
...
fn verify_to_int_unchecked_f32_i32(a: f32) {
...
fn verify_to_int_unchecked_f64_i64(a: f64) {
...
fn verify_to_int_unchecked_f128_i128(a: f128) {
