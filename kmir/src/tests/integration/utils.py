...
COMPILETEST_PERMANENT_EXCLUDE = [
    ...
    'packed/packed-tuple-struct-size.mir',
    ...
    'array-slice-vec/vec-matching.mir',
    'async-await/async-fn-size-moved-locals.mir',
    'async-await/async-fn-size-uninit-locals.mir',
    'binding/match-vec-alternatives.mir',
    ...
    'const-generics/slice-const-param.mir',
    ...
    'pattern/move-ref-patterns/move-ref-patterns-dynamic-semantics.mir',
    'realloc-16687.mir',
