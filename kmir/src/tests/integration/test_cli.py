...
# they don't differ between local checkouts and CI (e.g. symbolic-args.main.cli-stats-leaves).
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            (PROVE_DIR / 'symbolic-args.rs'),
            'main',
            False,
            id='symbolic-args.main',
        ),
        pytest.param(
...
def test_cli_show_minimize_proof(kmir: KMIR, tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    rs_file = PROVE_DIR / 'symbolic-args.rs'
    start_symbol = 'main'
