...
SCHEMA_PARSE_DATA = [
    ...
    (2, 'Local::Int', KApply('Local::Int', (KToken('2', KSort('Int')))), KSort('Local')),
    (
        {'StorageLive': 2},
        'StatementKind::StorageLive',
        KApply('StatementKind::StorageLive', (KApply('Local::Int', (KToken('2', KSort('Int')))))),
        KSort('StatementKind'),
    ),
    ('Not', 'Mutability::Not', KApply('Mutability::Not', ()), KSort('Mutability')),
    (2, 'Span::Int', KApply('Span::Int', (KToken('2', KSort('Int')))), KSort('Span')),
    (9, 'Ty::Int', KApply('Ty::Int', (KToken('9', KSort('Int')))), KSort('Ty')),
    (
        ...
        KApply(
            'LocalDecl::Ty::Span::Mutability',
            (
                KApply('Ty::Int', (KToken('9', KSort('Int')))),
                KApply('Span::Int', (KToken('420', KSort('Int')))),
