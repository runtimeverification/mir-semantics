...
SCHEMA_PARSE_DATA = [
    ...
    (2, 'local::Local::Int', KApply('local::Local::Int', (KToken('2', KSort('Int')))), KSort('Local')),
    (
        {'StorageLive': 2},
        'StatementKind::StorageLive',
        KApply('StatementKind::StorageLive', (KApply('local::Local::Int', (KToken('2', KSort('Int')))))),
        KSort('StatementKind'),
    ),
    ('Not', 'Mutability::Not', KApply('Mutability::Not', ()), KSort('Mutability')),
    (2, 'span::Span::Int', KApply('span::Span::Int', (KToken('2', KSort('Int')))), KSort('Span')),
    (9, 'ty::Ty::Int', KApply('ty::Ty::Int', (KToken('9', KSort('Int')))), KSort('Ty')),
    (
        {'mutability': 'Mut', 'span': 420, 'ty': 9},
        'localDecl::LocalDecl::Ty::Span::Mutability',
        KApply(
            'localDecl::LocalDecl::Ty::Span::Mutability',
            (
                KApply('ty::Ty::Int', (KToken('9', KSort('Int')))),
                KApply('span::Span::Int', (KToken('420', KSort('Int')))),
