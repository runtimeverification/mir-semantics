...
```{.k .symbolic}
  ...
  rule [cheatcode-is-spl-account]:
    ...
    ensures #isSplPubkey(?SplMintKey)
      ...
      andBool (Integer(0, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplHasDelegateKey)) orBool Integer(1, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplHasDelegateKey)))
      ...
      andBool (Integer(0, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplIsNativeLamportsVariant)) orBool Integer(1, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplIsNativeLamportsVariant)))
      ...
      andBool (Integer(0, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplHasCloseAuthKey)) orBool Integer(1, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplHasCloseAuthKey)))
  ...
  rule [cheatcode-is-spl-mint]:
    ...
    ensures 0 <=Int ?SplMintHasAuthKey andBool ?SplMintHasAuthKey <=Int 1
      andBool (Integer(0, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplMintHasAuthKey)) orBool Integer(1, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplMintHasAuthKey)))
      andBool #isSplPubkey(?SplMintAuthorityKey)
      andBool 0 <=Int ?SplMintHasFreezeKey andBool ?SplMintHasFreezeKey <=Int 1
      andBool (Integer(0, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplMintHasFreezeKey)) orBool Integer(1, 0, false) ==K #lookupDiscrAux(discriminant(0) discriminant(1) .Discriminants, variantIdx(?SplMintHasFreezeKey)))
